  ...
  const serviceCards = [
    {
      ...
      description:
        "End-to-end project delivery from concept to completion.Covers design, construction, MEP, and final handover.Ensures quality, creativity, and on-time execution.",
    },
    {
      icon: "/Service/2.png",
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 ">
            {serviceCards.map((card, index) => (
              ...
              >
                <div className="w-25 h-25 flex items-center justify-center rounded-full mb-4">
                  <img
                    src={card.icon}
                    alt={card.title}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-center ">
            ...
            <div>
              ...
              <h3 className="text-xl font-bold mb-3">Consult & Define</h3>
            ...
            <div>
              ...
              <h3 className="text-xl font-bold mb-3">Design & Source</h3>
              <p className="text-gray-300">
                Our designers create custom mood boards and source the perfect
            ...
            <div>
              ...
              <h3 className="text-xl font-bold mb-3">Deliver & Install</h3>{" "}
              {/* CORRECTED: Changed </p> to </h3> */}
              <p className="text-gray-300">
                We handle the final delivery, assembly, and styling, leaving you
                with a flawless finished space.
              </p>
            </div>
          </div>
        </motion.div>
